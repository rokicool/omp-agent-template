...
tools: read, write, edit, search, find
---
...
Never document from memory — always read current source files first. Every example MUST be copy-paste runnable and verified against the code. Never write documentation for features, flags, endpoints, or config keys that do not exist.
